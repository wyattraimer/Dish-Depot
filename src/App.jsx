        ...
        <div className="container">
          ...
          {activeView === 'recipes' ? (
            filteredRecipes.length > 0 ? (
              <RecipeGrid
                recipeCardViewModels={recipeCardViewModels}
                ...
                hasSelectedGroup={isUuidLike(selectedGroupId)}
                selectedGroupName={selectedGroup?.name || 'group'}
                ...
                onOpenRecipe={openFocusedRecipe}
                onVisitRecipe={visitRecipe}
                onCopyRecipeUrl={copyRecipeUrl}
                onPrintRecipe={(recipe) => printRecipesAsPdf([recipe])}
                onOpenShareModal={openShareModal}
                onAddRecipeToSelectedGroup={addRecipeToSelectedGroup}
                onRemoveRecipeFromSelectedGroup={removeRecipeFromSelectedGroup}
                onTogglePinnedRecipe={togglePinnedRecipe}
                onEditRecipe={openModal}
